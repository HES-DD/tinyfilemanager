...
//Application Title
define('APP_TITLE', 'Media File Manager');
                            ...
                            <div class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    <div class="form-group">
                                       <div class="brand">
                                           <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 109.9 20"><title>Hirmer Logo</title><path d="M19,3.3h1V0H12.7V3.3h1a.764.764,0,0,1,.5.2.764.764,0,0,1,.2.5V7.8H5.7V4a.764.764,0,0,1,.2-.5.764.764,0,0,1,.5-.2h1V0H0V3.3H1a.764.764,0,0,1,.5.2c.1.2.2.3.2.5V16c0,.2-.1.3-.2.5a.764.764,0,0,1-.5.2H0V20H7.3V16.7h-1a.684.684,0,0,1-.7-.7V11.9h8.7V16c0,.2-.1.3-.2.5a.764.764,0,0,1-.5.2h-1V20H20V16.7H19a.684.684,0,0,1-.7-.7V4c0-.2.1-.3.2-.5A.764.764,0,0,1,19,3.3ZM68,7v9c0,.2-.1.3-.2.5a.764.764,0,0,1-.5.2h-1V20h7.3V16.7h-1a.764.764,0,0,1-.5-.2A.9.9,0,0,1,72,16V4c0-.2.1-.3.2-.5a.764.764,0,0,1,.5-.2h1V0H68L61.7,9.1,55.5,0H49.8V3.3h1a.764.764,0,0,1,.5.2.764.764,0,0,1,.2.5V16c0,.2-.1.3-.2.5a.764.764,0,0,1-.5.2h-1V20h7.3V16.7h-1a.684.684,0,0,1-.7-.7V7l6,8.7c0,.1.2.2.3.2s.2-.1.3-.2ZM28.5,3.3h1V0H22.2V3.3h1a.764.764,0,0,1,.5.2.764.764,0,0,1,.2.5V16c0,.2-.1.3-.2.5a.764.764,0,0,1-.5.2h-1V20h7.3V16.7h-1a.684.684,0,0,1-.7-.7V4a.764.764,0,0,1,.2-.5A.764.764,0,0,1,28.5,3.3ZM91.6,0H75.8V3.3h1a.764.764,0,0,1,.5.2.764.764,0,0,1,.2.5V16c0,.2-.1.3-.2.5a.764.764,0,0,1-.5.2h-1V20H91.6V14.7H87.7V16c0,.2-.1.3-.2.5a.764.764,0,0,1-.5.2H82.2a.684.684,0,0,1-.7-.7V11.9h4.2v-4H81.5V4a.764.764,0,0,1,.2-.5.764.764,0,0,1,.5-.2H87a.764.764,0,0,1,.5.2.764.764,0,0,1,.2.5V5.3h3.9ZM37.4,16.4a.764.764,0,0,1-.2-.5V12.7h1.5l4,6.3a1.79,1.79,0,0,0,1.4.9h3.7V16.6H46.6a1.79,1.79,0,0,1-1.4-.9l-2.1-3.3a6,6,0,0,0,4.6-6.1c0-4.7-3.3-6.3-6.5-6.3H31.4V3.3h1a.764.764,0,0,1,.5.2.764.764,0,0,1,.2.5V16c0,.2-.1.3-.2.5a.764.764,0,0,1-.5.2h-1V20h7.3V16.7h-1c.1,0-.1-.1-.3-.3Zm0-12.9a.764.764,0,0,1,.5-.2H41c1,0,2.6.4,2.6,2.8S42,8.8,41,8.8H37.2V4C37.2,3.8,37.3,3.7,37.4,3.5Zm70,12.2-2.1-3.3a6,6,0,0,0,4.6-6.1c0-4.7-3.3-6.3-6.5-6.3H93.6V3.3h1a.764.764,0,0,1,.5.2.764.764,0,0,1,.2.5V16c0,.2-.1.3-.2.5a.764.764,0,0,1-.5.2h-1V20h7.3V16.7h-1a.684.684,0,0,1-.7-.7V12.8h1.5l4,6.3a1.79,1.79,0,0,0,1.4.9h3.7V16.7h-1.2c-.7,0-1.2-.9-1.2-1Zm-4.2-6.9H99.4V4a.764.764,0,0,1,.2-.5.764.764,0,0,1,.5-.2h3.1c1,0,2.6.4,2.6,2.8a2.409,2.409,0,0,1-2.6,2.7Z"/></svg>
                                        </div>
...
include "hirmer-special-config.php";
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-hover table-sm <?php echo $tableTheme; ?>" id="main-table">
            ...
            foreach ($folders as $f) {
                ...
                $allowed = folderAllowedToBeModified($path . '/' . $f);
                ...
                <tr>
                    ...
                    <td class="inline-actions"><?php if (!FM_READONLY && $allowed): ?>
                        ...
                        <?php endif; ?>
                        <?php /* <a title="<?php echo lng('DirectLink')?>" href="<?php echo fm_enc(FM_ROOT_URL . (FM_PATH != '' ? '/' . FM_PATH : '') . '/' . $f . '/') ?>" target="_blank"><i class="fa fa-link" aria-hidden="true"></i></a> */ ?>
                    </td>
                </tr>
                <?php
                flush();
            ...
            foreach ($files as $f) {
                ...
                <tr>
                    ...
                    <td class="inline-actions">
                        ...
                        <?php endif; ?>
                        <?php /* <a title="<?php echo lng('DirectLink') ?>" href="<?php echo fm_enc(FM_ROOT_URL . (FM_PATH != '' ? '/' . FM_PATH : '') . '/' . $f) ?>" target="_blank"><i class="fa fa-link"></i></a> */ ?>
...
<head>
    ...
    <style>
        ...
        .fm-login-page .brand{ width:121px;overflow:hidden;margin:0 auto;position:relative;z-index:1; padding-bottom: 8px}
...
function folderAllowedToBeModified($path) {

    $relpath = str_replace(FM_ROOT_PATH, "", $path);

    $allowed = true;

    foreach(HRM_CONFIG["folders_forbidden_to_modify"] as $p) {
        if($relpath === $p) {
            $allowed = false;
        }
    }
